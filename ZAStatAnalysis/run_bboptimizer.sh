...
# [ LOCAL ] Now to rebin the original data with different scenarios using the json file saved above
#=====================================================================
...
# [ SLURM ] jobs submssion from bambooDir, 1 root file for each job 
#=====================================================================
input=${2}
era='fullrun2'
