...
def runPlotIt_postFits(workdir=None, mode=None):
        ...
        for cat_path in plotit_histos:
            ...
            flavor     =  'ee channel' if 'ElEl' in output else '$#mu#mu$ channel'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode', action='store', required=True, default=None, choices=['mjj_vs_mlljj', 'mjj_and_mlljj', 'mjj', 'mlljj', 'ellipse', 'dnn'], help='')

    options = parser.parse_args()
    runPlotIt_postFits(workdir=options.inputs, mode=options.mode)
