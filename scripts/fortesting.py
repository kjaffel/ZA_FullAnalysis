...
f = ROOT.TFile.Open("/home/ucl/cp3/kjaffel/bamboodev/myanalysis/ScaleFactors_94X_2016legacy_RootFiles/RunBCDEF_SF_ID.root")
...
for key in f.GetListOfKeys():
    ...
    filename = 'Muon_%s_genTracks_id.json' % (wp)
